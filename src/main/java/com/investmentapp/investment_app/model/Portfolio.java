...
public class Portfolio implements Serializable {
  ...
  public Portfolio(Portfolio other) {
    if (other != null) {
      ...
      this.initialBalance = other.initialBalance != null ? new BigDecimal(other.initialBalance.toString()) : null;
      this.currentBalance = other.currentBalance != null ? new BigDecimal(other.currentBalance.toString()) : null;
