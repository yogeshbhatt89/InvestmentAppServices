...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Object> handleNoHoldingsToSell(NoHoldingsToSellException ex) {
    ...
    ErrorResponse errorResponse = new ErrorResponse(HttpStatus.BAD_REQUEST.value(), "No holdings to sell", ex.getMessage());
  ...
  public ResponseEntity<Object> handleInsufficientBalance(InsufficientBalanceException ex) {
    // Create a response object with a custom message
    ErrorResponse errorResponse = new ErrorResponse(HttpStatus.BAD_REQUEST.value(), ex.getMessage(), ex.getMessage());
    return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
  }
  ...
  public ResponseEntity<Object> handleInvalidCredentials(InvalidCredentialsException ex) {
    ErrorResponse errorResponse = new ErrorResponse(HttpStatus.UNAUTHORIZED.value(), ex.getMessage(), ex.getMessage());
